...
Pour supprimer la musique de votre smartphone, il suffit de désactiver le bouton **Télécharger les pistes** ou **Télécharger la piste**`,
      type: 'markdown',
    },
    {
      content: "la musique n'est pas chargée.",
      type: 'text',
      style: { color: 'blue' },
    },
    {
      content: 'la musique est chargée',
      type: 'text',
      style: { color: 'green' },
    },
    {
      content: 'téléchargement de la musique en cours',
      type: 'text',
      style: { color: 'orange' },
    },
    {
      content: 'musique en cours de lecture',
      type: 'text',
      style: { color: 'red' },
    },
    {
      content: 'Crédits',
      url: 'http://www.zonoff.net/belvederesonore/index.php/credits/',
      type: 'link',
    },
    {
      content: 'Politique de confidentialité',
      url: 'https://dispatchwork.info/peso/policy.html',
      type: 'link',
    },
  ],
}
